  ...
  return (
    <Container>
      ...
      <BodyContainer>
        <ButtonContainer>
          <Button>
            <img src={denovaliLogo} alt='labelLogo0' onClick={()=> labelHandler(90336)}/>
          </Button>
          <Button>
            <img src={ErasedTapesLogo} alt='labelLogo1' onClick={()=> labelHandler(88949)}/>
          </Button>
          <Button>
            <img src={kirecordsLogo} alt='labelLogo2' onClick={()=> labelHandler(153824)}/>
          </Button>
          <Button>
            <img src={miasmah_logo} alt='labelLogo3' onClick={()=> labelHandler(23127)}/>
          </Button>
          <Button>
            <img src={SONICPIECES_LOGO} alt='labelLogo4' onClick={()=> labelHandler(157803)}/>
          </Button>
        </ButtonContainer>
        <ReleasesContainer>
            <ReleasesSmall/>
